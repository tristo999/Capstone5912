...
namespace Aura2API
{
    ...
    public class Frustum
    {
        ...
        public void ComputeData()
        {
            ...
            _computeDataComputeShader.SetFloat("ambientLightingFactor", _frustumSettings.BaseSettings.ambientLightingStrength * (RenderSettings.ambientMode == UnityEngine.Rendering.AmbientMode.Skybox ? Mathf.PI * RenderSettings.ambientIntensity : 1.0f));
            #endregion
