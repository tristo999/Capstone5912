...
namespace Aura2API
{
    ...
    public class SceneViewToolbox
    {
        ...
        private static bool ShouldRepaintSceneView
        {
            get
            {
                return _toolboxExpansionWeight > 0.0f || _toolboxExpansionWeight < 1.0f
                    ...
                    || _presetsApparitionWeight > 0.0f || _presetsApparitionWeight < 1.0f;
            }
        }
        ...
        private static void OnSceneViewGUI(SceneView sceneView)
        {
            ...
            if (IsExpanded || _toolboxExpansionWeight > 0)
            {
                if(!_isInitialized)
                {
        ...
        private static void Initialize(SceneView sceneView)
        {
            ...
            _focusAfterCreationToggleContent = new GUIContent("Toggle Focus", Aura.ResourcesCollection.focusIconTexture, "Focus on Volume after creation");
        ...
        {
            Handles.BeginGUI();
            GUILayout.Window(GUIUtility.GetControlID(0, FocusType.Passive, _toolboxWindowRect), _toolboxWindowRect, DrawToolboxBody, "", GuiStyles.ButtonNoHoverNoBorder);
            Handles.EndGUI();
        }
        ...
        {
            Handles.BeginGUI();
            GUILayout.Window(GUIUtility.GetControlID(0, FocusType.Passive, _activationToggleButtonRect), _activationToggleButtonRect, DrawActivationToggleButtonBody, "", GuiStyles.ButtonNoHoverNoBorder);
            Handles.EndGUI();
        }
        ...
        {
            Handles.BeginGUI();
            GUILayout.Window(GUIUtility.GetControlID(0, FocusType.Passive, _displayToggleButtonsRect), _displayToggleButtonsRect, DrawDisplayToggleButtonBody, "", GuiStyles.ButtonNoHoverNoBorder);
            Handles.EndGUI();
        }
        ...
        {
            Handles.BeginGUI();
            GUILayout.Window(GUIUtility.GetControlID(0, FocusType.Passive, _presetsWindowRect), _presetsWindowRect, DrawPresetsWindowBody, "", GuiStyles.ButtonNoHoverNoBorder);
            Handles.EndGUI();
        }
        ...
        public static void Expand(bool visibility)
        {
            ...
            ShowNotification(new GUIContent((visibility ? " Expandig" : " Collapsing") + " Toolbox", Aura.ResourcesCollection.logoIconTexture));
        }
        #endregion
        #endregion        
        #endregion
