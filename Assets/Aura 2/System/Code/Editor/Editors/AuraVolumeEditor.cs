...
namespace Aura2API
{
    ...
    public class AuraVolumeEditor : Editor
    {
        ...
        private void DisplayLightProbesLightingInjectionArea()
        {
            ...
            GuiHelpers.DrawToggleChecker(ref _useAsLightProbesProxyVolumeProperty, new GUIContent("Light Probes Lighting", Aura.ResourcesCollection.illuminationIconTexture), true, true);
